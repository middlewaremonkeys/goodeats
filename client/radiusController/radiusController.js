...
// .controller('radiusController', function($scope, Search) {
	
//   $scope.radius.kilometers = 0; 

//   $scope.radius.meters = ($scope.radius.kilometers * 1000)	
//   if($scope.radius.meters > 40000){
//   	$scope.radius.meters = 40000
//   };

//   $scope.query = Search.options.radius;
